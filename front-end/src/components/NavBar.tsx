    ...
    <header className="w-full h-16 flex items-center justify-between px-6 bg-white border-b border-gray-200 ">
      ...
      <nav>
        <ul className="flex gap-8 text-[15px] font-medium text-gray-700">
          <li className="cursor-pointer hover:text-black transition">Recognize</li>
          <li className="cursor-pointer hover:text-black transition">History</li>
          <li className="cursor-pointer hover:text-black transition">Admin</li>
        </ul>
      </nav>
